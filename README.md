## <p align='center'>Привет, меня зовут Катя! <img src="https://github.com/blackcater/blackcater/raw/main/images/Hi.gif" height="32"/></p>
...
|----------------|-----------------|--------|
|Аналитик данных|Разработка загрузочных скриптов в Qlik Sense с целью обеспечения эффективной обработки данных и их интеграции. Оркестрация процессов в Qlik Sense для оптимизации рабочего потока и повышения производительности аналитики. Создание интуитивно понятных дашбордов в Qlik Sense для визуализации данных и поддержки принятия управленческих решений. Выполнение ad-hoc запросов. Автоматизация процессов отчетности с использованием Python, что позволяет сократить временные затраты и повысить точность данных. РFM-сегментация клиентов для глубокого анализа клиентской базы и выявления ключевых групп с целью увеличения продаж и улучшения обслуживания. Выгрузка данных из баз данных для дальнейшего анализа и формирования отчетов. Разработка процедур по сбору и анализу аудитории.|март 2024 - настоящее время|
</div>
